...
class HabitSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Habit
        fields = [
            'id', 'user', 'place', 'date', 'action', 'is_pleasant', 
            'related_habit', 'reward', 'time_to_complete', 'is_public', 
            'periodicity'
        ]
...
class HabitCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Habit
        fields = [
            'place', 'date', 'action', 'is_pleasant', 'related_habit', 
            'reward', 'time_to_complete', 'is_public', 'periodicity'
        ]
